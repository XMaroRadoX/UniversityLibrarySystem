...
public class LibrarianLoginForm extends javax.swing.JFrame {
    ...
    public LibrarianLoginForm(Library library) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Header.setText("Librarian Login");
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        Libraian[] libs = library.getLibraians();
        ...
        for (int i = 0; i < libs.length; i++) {
            if (libs[i] == null) {
                break;
            } else if (nameField.getText().equals(libs[i].getName()) && passwordField.getText().equals(libs[i].getPassword())) {
