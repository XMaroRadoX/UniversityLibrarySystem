...
public class AddLibrarian extends javax.swing.JFrame {
    ...
    public AddLibrarian(Library library) {
        initComponents();
    ...
    private void addLibrarianButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addLibrarianButtonActionPerformed
        ...
        if (nameField.getText().equals("") && passwordField.getText().equals("") && mailField.getText().equals("") && addressField.getText().equals("") && cityField.getText().equals("") && contactField.getText().equals("")) {
        ...
        if (!errors) {
            int i = library.getLibraiansCount();
            library.getLibraians()[i++] = new Libraian(name, password, mail, city, address, contact);
            library.setLibraiansCount(i);
            saveInFile(library.getPath());
            JOptionPane.showMessageDialog(null, "Libraian added successfully!");
            AdminSection as = new AdminSection(library);
            dispose();
            as.setVisible(true);
        }
